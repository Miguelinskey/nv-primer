...
[data-color-mode="auto"][data-light-theme="light_high_contrast"] ::backdrop {
  ...
  --shadow-floating-small: 0px 0px 0px 1px #20252c, 0px 6px 12px -3px #343b430a, 0px 6px 18px 0px #343b431f;
  --shadow-floating-medium: 0px 0px 0px 1px #20252c, 0px 8px 16px -4px #343b4314, 0px 4px 32px -4px #343b4314, 0px 24px 48px -12px #343b4314, 0px 48px 96px -24px #343b4314;
  --shadow-floating-large: 0px 0px 0px 1px #20252c, 0px 40px 80px 0px #343b433d;
  --shadow-floating-xlarge: 0px 0px 0px 1px #20252c, 0px 56px 112px 0px #343b4352;
}
